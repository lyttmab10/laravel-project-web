...
@section('title', 'ผลงานนักศึกษา - สาขาวิศวกรรมซอฟต์แวร์')
    ...
    <section class="py-16 bg-white dark:bg-gray-900 dark-transition">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center py-16">
                ...
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">ไม่พบข้อมูลผลงานนักศึกษา</h2>
