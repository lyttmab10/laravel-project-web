...
<head>
    ...
    <title>จัดการผลงานนักศึกษา - Admin Dashboard</title>
...
<body class="bg-gray-100">
    ...
    <header class="bg-white shadow-sm border-b">
        <div class="px-6 py-4">
            <div class="flex items-center justify-between">
                <h1 class="text-xl font-bold text-gray-800">จัดการผลงานนักศึกษา</h1>
    ...
    <div class="flex">
        ...
        <nav class="w-64 bg-white shadow-sm h-screen">
            <div class="p-6">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('admin.student.projects') }}" class="flex items-center p-3 text-gray-700 bg-primary-50 border-r-4 border-primary-500 rounded-l">
                            <span class="mr-3">💻</span>
                            ผลงานนักศึกษา
                        </a>
                    </li>
        ...
        <main class="flex-1 p-6">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">ข้อมูลผลงานนักศึกษา</h2>
                <p class="text-gray-600">จัดการข้อมูลโครงการและผลงานของนักศึกษาสาขาวิศวกรรมซอฟต์แวร์</p>
            </div>
            
            @if($studentProjects && count($studentProjects) > 0)
                    ...
                    <table class="min-w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ชื่อโครงการ</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">นักศึกษา</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ปีที่ทำ</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $project->student_name }}</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    @if($project->image)
                                        <img src="{{ $project->image }}" alt="Project Image" class="h-10 w-10 rounded object-cover">
                                    @else
                                        ไม่มีรูปภาพ
                                    @endif
                                </td>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-center py-8">
                    <p class="text-gray-500">ไม่มีข้อมูลผลงานนักศึกษาในระบบ</p>
                    <p class="text-sm text-gray-400 mt-2">กรุณาเพิ่มข้อมูลผลงานนักศึกษาใหม่</p>
                </div>
            </div>
            @endif
